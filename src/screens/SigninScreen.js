...
const SigninScreen = (props) => {
  ...
  const configureGoogleSign = () => {
    GoogleSignin.configure({
      webClientId:
        '158637660260-netmu2sctk944p3j6smq64urglrjk5pf.apps.googleusercontent.com',
      offlineAccess: false,
    });
  };
      ...
      <ScrollView
        ...
        <View style={{marginTop: '2%', padding: '10%'}}>
          ...
          <Button
            ...
            onPress={() =>
              onButtonPress(props.email, props.password, props.isLoggedIn)
            }
          />
          <View
            style={{
        ...
        {isLoggedIn === true ? (
          ...
          <View
            ...
            <Text>Not have an Accoount? </Text>
            <TouchableOpacity
              onPress={() => props.navigation.navigate('SignUpp')}>
              <Text
                style={{fontSize: 16, fontWeight: 'bold', color: '#1ec31e'}}>
                Signup
              </Text>
            </TouchableOpacity>
          </View>
